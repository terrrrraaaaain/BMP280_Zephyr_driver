...
#define BMP280_OVERSAMPLING_TEMPERATURE_X_0 0b00000000 // same as BMP280_OVERSAMPLING_TEMPERATURE_X_1 as temperature is required for proper pressure readings
...
#define BMP280_MASK_CTRL_MEAS_MODE 0b00000011
#define BMP280_MASK_CTRL_MEAS_OSRS_T 0b11100000
#define BMP280_MASK_CTRL_MEAS_OSRS_P 0b00011100

// CTRL_MEAS setters and getters
#define BMP280_CTRL_MEAS_SET_MODE(ctrl_meas, mode) (ctrl_meas & ~BMP280_MASK_CTRL_MEAS_MODE) | (mode)
#define BMP280_CTRL_MEAS_SET_OSRS_T(ctrl_meas, osrs_t) (ctrl_meas & ~BMP280_MASK_CTRL_MEAS_OSRS_T) | (osrs_t)
#define BMP280_CTRL_MEAS_SET_OSRS_P(ctrl_meas, osrs_t) (ctrl_meas & ~BMP280_MASK_CTRL_MEAS_OSRS_P) | (osrs_t)

#define BMP280_CTRL_MEAS_GET_MODE(ctrl_meas) (ctrl_meas & BMP280_MASK_CTRL_MEAS_MODE)
#define BMP280_CTRL_MEAS_GET_OSRS_T(ctrl_meas) (ctrl_meas & BMP280_MASK_CTRL_MEAS_OSRS_T)
#define BMP280_CTRL_MEAS_GET_OSRS_P(ctrl_meas) (ctrl_meas & BMP280_MASK_CTRL_MEAS_OSRS_P)
...
//  CONFIG Masks
#define BMP280_MASK_STATUS_MEASURING 0b00001000
#define BMP280_MASK_STATUS_IM_UPADTE 0b00000001
